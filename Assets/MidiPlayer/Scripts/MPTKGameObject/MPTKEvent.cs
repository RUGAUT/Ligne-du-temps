...
namespace MidiPlayerTK
{
    ...
    public partial class MPTKEvent : ICloneable
    {
        ...
        /// <summary>@brief
        /// Beat in the measure of this event. Present in all MIDI events, but only has musical meaning for note-on. 
        ...
        /// <summary>@brief
        /// Real time in milliseconds of this MIDI event from the start of the MIDI. It takes tempo changes into account, but not MidiFilePlayer.MPTK_Speed.\n
        ...
        /// <summary>@brief
        /// When #Command = #MPTKCommand.NoteOn, contains duration of the note in milliseconds.\n
        /// Sets -1 for a note-on played indefinitely.\n
        /// @version 2.10.0 
        /// @note
        ...
        /// <summary>@brief
        /// Short delay before playing the note in milliseconds. Available only in Core mode.
        ...
        /// @details
        /// Duration in ticks is converted in duration in milliseconds see (#Duration) when the MIDI file is loaded.
        /// @note
        /// Maestro does not use this value for playing a MIDI file but the #Duration in milliseconds.
        ...
        /// <summary>@brief
        /// Creates a MPTK MIDI event from a MIDI input message
        /// </summary>
        ...
        /// <summary>@brief
        /// Builds a packet MIDI message from a MPTKEvent. Example:  0x00403C90 for a noton (90h, 3Ch note,  40h volume)
        /// </summary>
        /// <returns></returns>
        public ulong ToData()
        {
        ...
        /// <summary>@brief
        /// Builds a string description of the MIDI event. V2.83 removes "end of lines" on each returns string.
