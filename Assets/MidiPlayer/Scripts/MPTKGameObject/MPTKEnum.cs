...
namespace MidiPlayerTK
{
    ...
    public enum MPTKCommand : byte
    {
        /// <summary>@brief
        /// Note Off\n
        /// Stops the note defined with the Value and the Channel\n
        ...
        ///      - MPTKEvent#Duration the duration of the note in milliseconds, -1 for infinite\n
        ///      - MPTKEvent#Channel the midi channel between 0 and 15\n
