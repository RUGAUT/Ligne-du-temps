...
namespace MidiPlayerTK
{
    ...
    public partial class MidiSynth : MonoBehaviour
    {
        ...
        /// <summary>@brief
        /// Time in milliseconds from the start of play
        /// </summary>
        ...
        /// <summary>@brief
        /// Time in milliseconds for the current MIDI playing position
        /// </summary>
 ...
 /// </summary>
        ...
        */
        ...
        /// But in some cases, you could have to call MPTK_InitSynth to restore initial condition of the synth (mainly useful with MidiStreamPlayer)
        /// </summary>
        ...
        /// and are younger than the first voice process created by this note-on event.
        /// </summary>
        [HideInInspector]
        ...
        /// <summary>@brief
        /// When a note is stopped with a note-off or when the duration is over, note continue to play for a short time depending the instrument.
        ...
        /// Performance issue: the longer it lasts the more CPU is used after the note-on. With a long release time, a lot of samples will be played simultaneously.
        /// </summary>
        ...
        /// Sets to 1 for an immediate full volume at start.
        /// </summary>
        [Range(0.001f, 1f)]
        ...
        /// <summary>@brief
        /// Change pan from MIDI Events in the SoundFont.
        ...
        /// <summary>@brief
        /// [Only when CorePlayer=False] Define a minimum release time at note-off in 100 nanosecond units.
        ...
        /// @note MPTK_AudioListener by default is defined with the first AudioListener found in the scene. You can define your own AudioListener from the inspector of the MidiPlayerGlobal prefab.
        /// @version 2.18.0 Pro
        /// </summary>
        [HideInInspector]
        ...
        /// <summary>@brief
        /// Return the angle in degree between the sound source and the listener.
        /// 0� = in front
        /// +90� = right
        /// -90� = left
        /// �180� = behind
        ...
        /// - When the source is exactly behind the listener, floating-point precision may cause the signed angle to be either +180� or -180�.
 ...
 /// </summary>
        ...
        /// <summary>@brief
        /// If true then MIDI events are read and playededed from a dedicated thread.
        ...
        /// <summary>@brief
        /// Sets or Get sample rate output of the synth. -1:default, 0:24000, 1:36000, 2:48000, 3:60000, 4:72000, 5:84000, 6:96000.
        ...
        /// <summary>@brief
        /// Sets or Get synth buffer size -1:default, 0:64, 1;128, 2:256, 3:512, 4:1024, 5:2048.
        ...
        /// <summary>@brief
        /// Count of the active voices (playing excluding voices in release step).
        /// Also, sound could be ear even if count = 0 from voices in release phase - Readonly
        /// </summary>
        ...
        /// @name Start Stop and Wait
        /// @{

        /// <summary>@brief
        /// Start the MIDI sequencer: each MIDI event is read and played in a dedicated thread.
        ...
        /// <summary>@brief
        /// Plays immediately one MIDI event.
        ...
        /// <summary>@brief
        /// Stops immediately the MIDI event play with @MPTK_PlayDirectEvent.
