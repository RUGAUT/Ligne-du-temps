...
namespace MidiPlayerTK
{
    ...
    public class MPTKChannels : IEnumerable<MPTKChannel>
    {
        ...
        /// <summary>@brief 
        /// Sets the volume for all channels as a percentage between 0 and 1. 
        /// </summary>
        ...
        /// Weird behaviors could occur if set to false with MidiFilePlayer, but it could be useful for MidiStreamPlayer.
        /// @version 2.10.1
        /// </summary>
    ...
    public class MPTKChannel
    {
        ...
        /// <summary>@brief 
        /// Builds an information string about the channel. It's also a good pretext to display an example of Channel API. \n
        /// Exemple of return 
        ...
        /// <summary>@brief 
        /// Gets or Set the count of notes (NoteOn) played since the start of the MIDI.
        /// Sets could be usefull to reset the value to 0.
        /// </summary>
        public int NoteCount { get { return count; } set { count = value; } }

        /// <summary>@brief 
        /// Gets or Set the volume for a channel as a percentage between 0 and 1. 
        /// </summary>
        ...
        /// <summary>@brief 
        /// Gets or Set current preset number associated to the channel. Value must be between 0 and 127 (if you have a full GM SoundFont).\n
        ...
        /// <summary>@brief
        /// Gets or Set the current bank number associated to the channel.\n
        /// Each MIDI channel can play a different preset and bank.\n
        /// You can find bank and preset number with the menu Maestro / SoundFont Setup in Right Panel,\n
        /// click on buttons with an eye icon to get all the presets for each bank.
        /// </summary>
        ...
        /// <summary>@brief 
        /// Gets the current preset name for the channel.\n
        ...
        /// <summary>@brief 
        /// Gets or Set forced preset on the channel. MIDI will allways playing with this preset even if a MIDI Preset Change message is received.\n
        /// Sets to -1 to disable this behavior.
        /// </summary>
        ...
        /// <summary>@brief 
        /// Gets or Set forced bank on the channel from 0 to 65635. MIDI will allways using this bank even if a bank change message is received.\n
        /// Sets to -1 to disable this behavior.
        /// </summary>
        /// <returns>preset index, -1 if not set</returns>
        /// @snippet TestMidiFilePlayerScripting.cs ExampleUsingChannelAPI_2
