...
{
    /// <summary>
    /// Builds and plays real-time music in relation to user actions or algorithms. This class must be used with the prefab MidiStreamPlayer.\n
    /// 
    /// @attention 
    ///     - MidiStreamPlayer inherits from class MidiSynth. For clarity, only MidiStreamPlayer attributes are provided here. 
    ...
    public partial class MidiStreamPlayer : MidiSynth
    {
        ...
        /// <summary>@brief
        /// Plays one midi event from an instance of the class MPTKEvent.\n
        ...
        /// <summary>@brief
        /// Plays a list MIDI event from an instance of the class MPTKEvent.\n
        /// Run in a thread so the call return immediately.\n
        /// See also the method #MPTK_StopEvent to stop a note from an instance of MPTKEvent.
        ...
        /// <summary>@brief
        /// Stops playing the note. All samples associated to the note are stopped by sending a note-off.\n
